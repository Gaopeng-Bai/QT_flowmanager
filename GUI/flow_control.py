...
class Ui_flow_control(object):
    def setupUi(self, flow_control):
        ...
        flow_control.resize(844, 935)
        flow_control.setStyleSheet("background-color: rgb(85, 87, 83);\n"
"color: rgb(243, 243, 243);")
        self.layoutWidget = QtWidgets.QWidget(flow_control)
        self.layoutWidget.setGeometry(QtCore.QRect(9, 9, 321, 725))
        ...
        self.layoutWidget1 = QtWidgets.QWidget(flow_control)
        self.layoutWidget1.setGeometry(QtCore.QRect(360, 10, 391, 702))
