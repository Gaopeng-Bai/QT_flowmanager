...
"color: rgb(115, 210, 22);")
        ...
        self.flow_control_4 = QtWidgets.QPushButton(self.centralwidget)
        self.flow_control_4.setObjectName("flow_control_4")
        self.gridLayout_7.addWidget(self.flow_control_4, 5, 1, 1, 1)
        ...
        self.status_button_4 = QtWidgets.QPushButton(self.centralwidget)
        self.status_button_4.setObjectName("status_button_4")
        self.gridLayout_7.addWidget(self.status_button_4, 1, 1, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_7.addItem(spacerItem3, 1, 2, 1, 1)
        self.flow_button_4 = QtWidgets.QPushButton(self.centralwidget)
        self.flow_button_4.setObjectName("flow_button_4")
        self.gridLayout_7.addWidget(self.flow_button_4, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.flow_control_4.setText(_translate("MainWindow", "Flow Control"))
        self.status_button_4.setText(_translate("MainWindow", "Status"))
        self.flow_button_4.setText(_translate("MainWindow", "Flow"))
